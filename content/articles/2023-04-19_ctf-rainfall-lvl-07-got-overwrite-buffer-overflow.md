...
This executable is the 8th one from the ISO file provided to us as a CTF challenge, for more context please visit [here](https://github.com/aallali/42-rainfall).
